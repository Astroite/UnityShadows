...
namespace Astroite.Shadow
{
    ...
    public class ExponentialShadowMap : MonoBehaviour
    {
        ...
        Camera InitDepthCamera(GameObject lightObj, RenderTexture rt)
        {
            ...
            Color bgColor = new Color(100000f, 100000f, 100000f, 100000f);

            depthCamera.orthographic = true;
            depthCamera.backgroundColor = bgColor;
        ...
        void SetShaderGlobal()
        {
            ...
            Shader.SetGlobalFloat("_ESMScaleFactor", ESMScaleFactor);
        }
    ...
    [CustomEditor(typeof(ExponentialShadowMap))]
    public class ESMInspectorExtension : Editor
    {
        static List<string> options = new List<string>();

        public override void OnInspectorGUI()
        {
            ExponentialShadowMap shadowMap = (ExponentialShadowMap)target;
